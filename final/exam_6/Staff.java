...
public class Staff extends Member implements HealthInsurance {
	...
	Staff(String name,String phone,int age,float income,String unit,int workyear){
		super(name,phone,age,income);
		this.unit = unit;
		this.workyear = workyear;
	}
	Staff(String name,String phone,int age,float income,String unit){
		super(name,phone,age,income);
		this.unit = unit;
	}
	Staff(String name,String phone,int age,float income){
		super(name,phone,age,income);
	}
