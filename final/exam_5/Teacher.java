...
public class Teacher extends Member implements HealthInsurance{
	...
	Teacher(String name,String phone, int age,int income, String department, int seniority){
		super(name,phone,age,income);
		this.department = department;
		this.seniority = seniority;
	}
	Teacher(String name,String phone, int age,int income, String department){
		super(name,phone,age,income);
		this.department = department;		
	}
	Teacher(String name,String phone, int age,int income){
		super(name,phone,age,income);	
	}
